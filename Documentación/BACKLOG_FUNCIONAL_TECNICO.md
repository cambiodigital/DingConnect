...
68. Rediseño UX del shortcode público de recargas: debajo del número ahora se muestra un bloque `Paquete activo` con selector editable y ficha formateada de bundle (Beneficios recibidos, Operador, Monto y moneda); al elegir paquete, el flujo promueve la confirmación arriba y oculta los pasos inferiores hasta que el usuario pulse `Cambiar paquete`.
