...
- Operación masiva en modal de shortcodes creados: el modal de edición incluye buscador por nombre/SKU/operador y acciones rápidas `Marcar visibles` / `Quitar visibles` para gestionar catálogos grandes sin clic individual por fila.
