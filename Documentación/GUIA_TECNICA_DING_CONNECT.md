...
- Endurecimiento de pasarelas: en modo WooCommerce para recargas, si `woo_allowed_gateways` no coincide con pasarelas disponibles en runtime, el plugin aplica fallback a las pasarelas activas para no bloquear checkout y deja traza `[DingConnect][checkout_gateways]`.
